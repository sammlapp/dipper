...
const HELP_TOOLTIPS = {
  ...
  'inference-overlap': 'How much consecutive analysis windows overlap (0 = none). Overlapping clips can improve detection at window edges.',
  'inference-batch-size': 'Audio segments processed at once. Use 1 for CPU; 64–1024 for GPU. Default auto-selects batch size based on your hardware and the selected model.',
  'inference-workers': 'Parallel CPU threads for data loading. 0 is safest and often best on MacOS; 5-16 is optimal for most servers. Default auto-selects the number of workers based on your hardware and the selected model.',
